<template>
    <div>
        <p class="display-2 text-center font-weight-bold mb-5 mt-5">Carte régionale des travaux publics financés par la Banque Mondiale et la BAD</p><span id="explore"></span>
